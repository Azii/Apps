...
:: Android packaging
set AND_CERT_NAME="TruthOrDrink2"
set AND_CERT_PASS=Z123MoV1
set AND_CERT_FILE=cert\truthordrink.p12
...
set IOS_DEV_CERT_PASS=Z123MoV1
set IOS_PROVISION=cert\TruthOrDrink2.mobileprovision
